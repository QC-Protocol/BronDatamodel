...
def test_meetnet():
    adm = GMNAdm(**{"NetID": None, "BROID": None, "ObjRgstrDateTime": datetime2matlab(datetime.now()), "AccParty": "", "QualityRegime": "IMBRO", "DvRespParty": "bla", "LastRgstrEvent": None, "GMNID": 1})
